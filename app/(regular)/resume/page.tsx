...
import resume from '@/images/Jiaxi_Tang_Resume.webp'
  ...
  return (
    <main className='w-[90vw] h-[123.75vw] md:w-[70vw] md:h-[68.75vw] lg:w-[60vw] lg:h-[77.6vw] mx-auto mb-12 md:mb-16'>
      <p className='flex flex-row gap-1 md:hidden mb-2'>
        ...
        <a href="/images/Jiaxi_Tang_Resume.pdf" 
      ...
      <iframe 
        src="/images/Jiaxi_Tang_Resume.pdf" 
        className="hidden md:block min-w-fit w-full min-h-fit h-full" 
        allowFullScreen 
        title='Jiaxi Tang Resume'>
      </iframe>
      <Image src={resume} className="md:hidden w-full h-auto border border-gray-dark" alt="Jiaxi Tang resume"></Image>
    </main>
  );
};
